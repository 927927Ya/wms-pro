...
CREATE TABLE `customer`  (
  `id` bigint(20) NOT NULL COMMENT '客户表',
  `code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户编号',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户名',
  `customer_level` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户级别,参考sys_dict中的customer_level属性值',
  `customer_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户状态，参考sys_dict中的customer_status属性值',
  ...
  `business_intro` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主营业务',
  `is_enabled` tinyint(1) NULL DEFAULT 1 COMMENT '激活状态：激活（1）,否则（0）;缺省为1',
...
CREATE TABLE `inbound`  (
  ...
  `supplier_id` bigint(20) NOT NULL COMMENT '供应商id，为了简单起见，关联customer表',
  `warehouse_id` bigint(20) NULL DEFAULT NULL COMMENT '仓库id',
  `estimated_arrival_time` datetime(3) NULL DEFAULT NULL COMMENT '预计到达时间',
  `inbound_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '入库状态：待创建，进行中，已完成，已作废，参考字典表',
  `inbound_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '入库类型：采购入库、退货入库等（注意：期末项目不用考虑）。参考字典表',
  `create_time` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者id',
  `update_by` bigint(20) NULL DEFAULT NULL COMMENT '修改者id',
  `update_time` datetime(3) NULL DEFAULT NULL COMMENT '修改 时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `inbound_details`  (
  `id` bigint(20) NOT NULL COMMENT '注意，该表存储入库时sku对应的入库信息，包括批号，数量，生产日期等',
  `inbound_id` bigint(20) NOT NULL COMMENT '入库单id',
  `sku_id` bigint(20) NULL DEFAULT NULL COMMENT '产品sku id',
  `batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品批号no',
  `production_date` date NULL DEFAULT NULL COMMENT '生产日期(年月日)',
  `product_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品状态，参考sys_dict',
  `storage_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品单位，参考sys_dict',
  `to_received_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '应收数量',
  `received_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '实收数量',
  `weight_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '重量单位',
  `total_weight` decimal(20, 2) NULL DEFAULT NULL COMMENT '总重量',
  `pallet_count` int(10) NULL DEFAULT NULL COMMENT '所需托盘数量',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_inbound_id`(`inbound_id`) USING BTREE COMMENT '入库单id索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of inbound_details
-- ----------------------------
INSERT INTO `inbound_details` VALUES (2001, 1001, 1, '20251204212807-1', '2025-08-29', '0', '1', 152.00, 152.00, '1', 304.00, 4);
INSERT INTO `inbound_details` VALUES (2002, 1002, 2, '20241226144529', '2024-09-11', '0', '1', 477.00, 477.00, '1', 954.00, 12);
INSERT INTO `inbound_details` VALUES (2003, 1003, 3, '20250121175344', '2024-11-29', '0', '1', 63.00, 63.00, '1', 126.00, 2);
INSERT INTO `inbound_details` VALUES (2004, 1004, 4, '20250108112608', '2024-11-13', '0', '1', 3346.00, 3346.00, '1', 6692.00, 84);
INSERT INTO `inbound_details` VALUES (2005, 1003, 5, '20251113231442-1', '2025-09-22', '0', '1', 2423.00, 2423.00, '1', 4846.00, 61);
...
CREATE TABLE `inbound_receiving_task`  (
  `id` bigint(20) NOT NULL COMMENT '注意：一条入库详情对应一个sku商品，一个SKU商品可以对应多个收货任务，即多个托盘来收货。',
  `inbound_details_id` bigint(20) NOT NULL COMMENT '入库单详情id',
  `pallet_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '托盘名,例如 “PLT#1\"',
  `to_received_qty` decimal(10, 2) NULL DEFAULT NULL COMMENT '应收数量',
  `received_qty` decimal(10, 2) NULL DEFAULT NULL COMMENT '实收数量',
  `task_status` tinyint(4) NULL DEFAULT NULL COMMENT '任务完成状态',
  `bin_id` bigint(20) NULL DEFAULT NULL COMMENT '入库库位Id，外键关联warehouse_bin表',
  `operator_id` bigint(20) NULL DEFAULT NULL COMMENT '操作人id',
  `create_time` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `operation_time` datetime(3) NULL DEFAULT NULL COMMENT '操作时间',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_inbound_details_id`(`inbound_details_id`) USING BTREE COMMENT '入库详情id索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `inventory_batch`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'sku, batch_no, in warehouse: 描述在各仓库中，sku在各batch_no的存储情况',
  `warehouse_id` bigint(20) NOT NULL COMMENT '仓库id',
  `sku_id` bigint(20) NOT NULL COMMENT 'SKU id',
  `batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '入库的批号',
  `total_qty` decimal(20, 2) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '本批次的总数量',
  `available_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '本批次的可用数量',
  `frozen_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '本批次的冻结数量',
  `fda_hold` tinyint(1) NULL DEFAULT 0 COMMENT 'fda hold 是否被海关扣压: 默认0；否则1',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_sku_batch`(`sku_id`, `batch_no`) USING BTREE COMMENT 'sku+批号联合索引'
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of inventory_batch
-- ----------------------------
INSERT INTO `inventory_batch` VALUES (1, 1828364740028174337, 1, '20251204212807-1', 000000000000000152.00, 116.00, 36.00, 0);
INSERT INTO `inventory_batch` VALUES (2, 1828364740028174337, 2, '20241226144529', 000000000000000477.00, 472.00, 5.00, 0);
INSERT INTO `inventory_batch` VALUES (3, 1828364740028174337, 3, '20250121175344', 000000000000000063.00, 59.00, 4.00, 0);
INSERT INTO `inventory_batch` VALUES (4, 1828364740028174337, 4, '20250108112608', 000000000000003346.00, 3343.00, 3.00, 0);
INSERT INTO `inventory_batch` VALUES (5, 1828364740028174337, 5, '20251113231442-1', 000000000000002423.00, 2407.00, 16.00, 0);
...
CREATE TABLE `inventory_bin`  (
  `id` bigint(20) UNSIGNED ZEROFILL NOT NULL COMMENT '此表为 库位与sku，batch_no之间的关联表: 描述该库位上，该批次的sku对应的库存情况',
  `bin_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '库位id, 库位表外键，关联warehouse_bin表',
  `batch_id` bigint(20) NOT NULL COMMENT '批次id, 关联inventory_batch表',
  `product_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品状态：合格或不合格，具体值参考sys_dict',
  `total_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '库位中该批次产品存储的总数',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_batch_id`(`batch_id`) USING BTREE COMMENT '批次id索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of inventory_bin
-- ----------------------------
INSERT INTO `inventory_bin` VALUES (00000000000000000001, 'C2-7-4', 1, '0', 56.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000002, 'C2-7-5', 1, '0', 56.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000003, 'C15-14-1', 1, '0', 40.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000004, 'C15-26-1', 2, '0', 37.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000005, 'C19-6-6', 2, '0', 110.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000006, 'C19-7-5', 2, '0', 110.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000007, 'C20-6-6', 2, '0', 110.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000008, 'C20-7-5', 2, '0', 110.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000009, 'C18-39-1', 3, '0', 13.00);
INSERT INTO `inventory_bin` VALUES (00000000000000000010, 'D-21B-1', 3, '0', 50.00);
...
CREATE TABLE `inventory_history`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录库存库位的变化流水',
  `bin_id` bigint(20) NULL DEFAULT NULL COMMENT '库存库位id, 外键关联inventory_bin表',
  ...
  `inventory_op_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '库存操作类型, 参考sys_dict表',
  `related_order_id` bigint(20) NULL DEFAULT NULL COMMENT '关联单据id，例如出库单或入库单',
  `operation_date` datetime(3) NULL DEFAULT NULL COMMENT '操作时间',
  `operator_id` bigint(20) NULL DEFAULT NULL COMMENT '操作人员id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_bin_id`(`bin_id`) USING BTREE COMMENT '库位id索引'
) ENGINE = InnoDB AUTO_INCREMENT = 1843920324157591563 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1843920324082094088 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `outbound`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '出库单表',
  `warehouse_id` bigint(20) NOT NULL COMMENT '出库仓库',
  `outbound_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '出库状态，参考sys_dict表',
  `customer_id` bigint(20) NULL DEFAULT NULL COMMENT '客户，关联customer表',
  `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者id,外键关联sys_user',
  `create_time` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `outbound_date` date NULL DEFAULT NULL COMMENT '出货日期',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_customer_id`(`customer_id`) USING BTREE COMMENT '客户id索引'
) ENGINE = InnoDB AUTO_INCREMENT = 4003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of outbound
-- ----------------------------
INSERT INTO `outbound` VALUES (4001, 1828364740028174337, '2', 2, 1, '2025-12-15 09:00:00.000', '2025-12-16', '海鲜零售订单出库');
INSERT INTO `outbound` VALUES (4002, 1828364740028174337, '2', 2, 1, '2025-01-22 10:00:00.000', '2025-01-23', '罗非鱼订单出库');
...
CREATE TABLE `outbound_details`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '出库单详情',
  `outbound_id` bigint(20) NOT NULL COMMENT '出库单id, 关联outbound表',
  `sku_id` bigint(20) NOT NULL COMMENT '出库产品sku id,关联prod_sku表',
  `out_qty` decimal(10, 2) NULL DEFAULT NULL COMMENT '出库数量',
  `qty_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '出库数量单位，参考sys_dict中的storage_unit属性值',
  ...
  `weight_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '出库重量单位，参考sys_dict中的weight_unit属性值',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_outbound_id`(`outbound_id`) USING BTREE COMMENT '出库单id索引'
) ENGINE = InnoDB AUTO_INCREMENT = 5004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `outbound_picking_task`  (
  `id` bigint(20) NOT NULL COMMENT '拣货任务表，实现出库，并详细记录从哪个库位出了哪个sku的哪个批次的货。',
  `outbound_details_id` bigint(20) NULL DEFAULT NULL COMMENT '出库详情id，对应一个sku',
  `inventory_bin_id` bigint(20) NULL DEFAULT NULL COMMENT '出库库存库位id, 对应着可以出库的sku',
  `pallet_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '托盘名字，如果需要托盘，则需要设置托盘名字',
  ...
  `qty_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '出库单位，参考sys_dict中的storage_type',
  `operation_time` datetime(3) NULL DEFAULT NULL COMMENT '操作时间',
  `operator_id` bigint(20) NULL DEFAULT NULL COMMENT '操作员id',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注，如果作废，可以备注失败原因。',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_outbound_details_id`(`outbound_details_id`) USING BTREE COMMENT '出库详情id索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `prod_category`  (
  ...
  `category_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '类型名称',
  `order_num` int(11) NULL DEFAULT 0 COMMENT '显示顺序',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1' COMMENT '类型状态（0停用 1正常）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_parent_id`(`parent_id`) USING BTREE COMMENT '父分类id索引'
...
CREATE TABLE `prod_sku`  (
  `id` bigint(20) NOT NULL COMMENT '自增长',
  `sku_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `prod_name_eng` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '产品名（英文)',
  `prod_name_chn` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '产品名（中文)',
  `category_id` bigint(20) NULL DEFAULT NULL COMMENT '三级分类id',
  ...
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品图片地址',
  `outer_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品外包装图片地址',
  `inner_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品内包装图片地址',
  `is_enabled` tinyint(1) NULL DEFAULT NULL COMMENT '是否可用',
  `sale_storage_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '价格单位，关联sys_dict字典中的storage_unit属性，例如磅，箱',
  `storage_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '库存单位，关联sys_dict字典中的存储单位',
  ...
  `prod_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品类型，关联sys_dict字典中的product_type',
  `storage_type_id` bigint(20) NULL DEFAULT NULL COMMENT '存放类型id',
  `origin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产地',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `create_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `update_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改者',
...
CREATE TABLE `prod_storage_type`  (
  `id` bigint(20) NOT NULL,
  `storage_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '存放类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `prod_tag`  (
  ...
  `update_time` datetime(3) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1828407291103842309 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品品牌表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `prod_tag_sku`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tag_sku`(`tag_id`, `sku_id`) USING BTREE COMMENT '标签+sku联合索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_dict`  (
  ...
  `dict_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '字典选项编码',
  `dict_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字典选项名',
  `sort` int(4) NULL DEFAULT NULL COMMENT '显示时的顺序',
  `is_enable` tinyint(1) NOT NULL COMMENT '是否启用',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_dict_type`(`dict_type`) USING BTREE COMMENT '字典类型索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1829351166857367554 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user`  (
  ...
  `family_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户姓',
  `given_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名',
  `nick_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户昵称',
  `user_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'sys_user' COMMENT '用户类型（类似部门）',
...
CREATE TABLE `authorities`  (
  ...
  `authority_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '权限标识',
...
CREATE TABLE `warehouse`  (
  ...
  `is_active` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否可用：可用（1）；不可用（0）',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '地址',
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '城市',
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '州或省',
...
CREATE TABLE `warehouse_bin`  (
  ...
  `capcity_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '库位容量单位',
  `maximum_volume` decimal(10, 3) NULL DEFAULT NULL COMMENT '最大单库位体积',
  `volume_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '库位体积单位',
  `storage_rule` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '存放规则',
  `is_enabled` tinyint(1) NULL DEFAULT NULL COMMENT '是否可用',
  `low_storage_alert_rato` decimal(10, 2) NULL DEFAULT NULL COMMENT '低存储率提醒值（%）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_bin_name`(`bin_name`) USING BTREE COMMENT '库位名唯一索引',
  INDEX `idx_zone_bin`(`zone_id`) USING BTREE COMMENT '库区-库位关联索引'
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of warehouse_bin
-- ----------------------------
INSERT INTO `warehouse_bin` VALUES (1, 'C2-7-4', 1828364740028174337, 1, 7, '0', '0', 100.000, '1', 2.000, '11', '0', 1, 30.00);
INSERT INTO `warehouse_bin` VALUES (2, 'C2-7-5', 1828364740028174337, 1, 7, '0', '0', 100.000, '1', 2.000, '11', '0', 1, 30.00);
INSERT INTO `warehouse_bin` VALUES (3, 'C15-14-1', 1828364740028174337, 1, 14, '0', '1', 80.000, '1', 1.600, '11', '0', 1, 25.00);
INSERT INTO `warehouse_bin` VALUES (4, 'C15-26-1', 1828364740028174337, 1, 26, '0', '1', 80.000, '1', 1.600, '11', '0', 1, 25.00);
INSERT INTO `warehouse_bin` VALUES (5, 'C19-6-6', 1828364740028174337, 1, 6, '0', '0', 120.000, '1', 2.400, '11', '0', 1, 35.00);
INSERT INTO `warehouse_bin` VALUES (6, 'C19-7-5', 1828364740028174337, 1, 7, '0', '0', 120.000, '1', 2.400, '11', '0', 1, 35.00);
INSERT INTO `warehouse_bin` VALUES (7, 'C20-6-6', 1828364740028174337, 1, 6, '0', '0', 120.000, '1', 2.400, '11', '0', 1, 35.00);
INSERT INTO `warehouse_bin` VALUES (8, 'C20-7-5', 1828364740028174337, 1, 7, '0', '0', 120.000, '1', 2.400, '11', '0', 1, 35.00);
INSERT INTO `warehouse_bin` VALUES (9, 'C18-39-1', 1828364740028174337, 1, 39, '0', '1', 60.000, '1', 1.200, '11', '0', 1, 20.00);
INSERT INTO `warehouse_bin` VALUES (10, 'D-21B-1', 1828364740028174337, 1, 21, '1', '0', 150.000, '1', 3.000, '11', '0', 1, 40.00);
...
CREATE TABLE `warehouse_rack`  (
  `id` bigint(20) NOT NULL COMMENT '货架id',
  `rack_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货架名',
  `warehouse_id` bigint(20) NULL DEFAULT NULL COMMENT '仓库id',
  `zone_id` bigint(20) NULL DEFAULT NULL COMMENT '所属货区id',
  `length` decimal(10, 3) NULL DEFAULT NULL COMMENT '货架长度',
  `width` decimal(10, 3) NULL DEFAULT NULL COMMENT '货架宽度',
  `rack_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货架类型(参考sys_dict的rack_type)',
  `is_double` tinyint(1) NULL DEFAULT NULL COMMENT '双排货架',
  `position_in_double` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '双排位置（0内/1外，参考sys_dict）',
  `related_rack` bigint(20) NULL DEFAULT NULL COMMENT '关联货架（双排时）',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_zone_rack`(`zone_id`) USING BTREE COMMENT '库区-货架关联索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `warehouse_zone`  (
  ...
  `zone_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '库区名',
  `warehouse_id` bigint(20) NULL DEFAULT NULL COMMENT '仓库id',
  `layers` int(4) NULL DEFAULT NULL COMMENT '拥有的层数',
  `length` decimal(10, 3) NULL DEFAULT NULL COMMENT '长度',
  `width` decimal(10, 3) NULL DEFAULT NULL COMMENT '宽度',
  `is_enabled` tinyint(1) NULL DEFAULT NULL COMMENT '是否可用：1可用；0不可用',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_warehouse_zone`(`warehouse_id`) USING BTREE COMMENT '仓库-库区关联索引'
